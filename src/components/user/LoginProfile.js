...
export default class LoginProfile extends Component {
    ...
    <div>        
        ...
        <h4 className='logintext text-center '>Please create your username and password. Remember, you do not need to login to schedule an in-home estimate, simply click on Contact Us below.
        </h4>
        ...
        <div className='row'>
            <div className='col-sm-6'>
                ...
                <h4> If this is your first time logging in, please complete all fields to create your profile in our records. You will only need to do this once. You can always update your profile later.
                </h4>
                <div className="form-group">
