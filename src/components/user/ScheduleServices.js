    ...
    return (
      <div>
        ...
        <div className="form-control">
          ...
          <h3 className="text-center">
            Please tap on the calendar, frequency and time charts to tell us
            when to clean for you.
          </h3>

          <h3 className="text-center">Weekdays or weekends , your choice!</h3>
          <h5 className="text-center">
            Remember, you can always edit your choices (including; services,
            date, frequency and time).
          </h5>
          <div className="row">
            ...
            <div className="col-lg-4 text-center">
              ...
              <button className="btn btn-block btn-outline-primary ml-3">
                <h2>Submit Your Order</h2>
              </button>

              <h6 className="special mb-5">
            ...
            <div className="col-lg-4 text-center">
              ...
              <img
                className="img-fluid text-center mb-5 p-5"
                src={discount}
                alt=""
                width="90%"
                height="90%"
